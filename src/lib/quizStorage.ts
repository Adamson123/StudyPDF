...
// /**
//  * Saves multiple quizzes sets to localStorage, replacing existing ones with the same IDs.
//  */
// export const saveMultipleQuizzes = (quizzes: AllStoredQuizzes) => {
//     //Filter out already existing one's
//     const existingQuizzes = getAllQuizzesFromStorage();
//     const newQuizzes = quizzes.filter(
//         (q) => !existingQuizzes.find((q2) => q2.id === q.id),
//     );

//     saveAllQuizzesToStorage([...existingQuizzes, ...newQuizzes]);
// };
